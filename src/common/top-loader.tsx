...
export function TopLoader() {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-start justify-center animate-[fadeIn_0.25s_ease-out]">
      ...
      <div className="relative mt-[30px] flex h-14 w-14 items-center justify-center">
        <div className="absolute inset-[-120px] rounded-full bg-lime-400/45 blur-3xl animate-[glowPulse_2s_ease-in-out_infinite]" aria-hidden="true" />
