...
class ClientLogger {
    ...
    trace(message: string, data?: Record<string, unknown>) { this.log('trace', message, data) }
    ...
    private buildEntry(level: LogLevel, message: string, data?: Record<string, unknown>): ClientLogEntry {
