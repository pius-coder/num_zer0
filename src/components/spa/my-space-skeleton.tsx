    ...
    <div className="flex h-dvh flex-col bg-background">
      <div className="flex h-dvh flex-col bg-background animate-pulse [&_svg]:opacity-40 [&_svg]:text-foreground [&_input]:opacity-40">
        ...
        <header className="relative isolate overflow-hidden hidden h-32 shrink-0 items-center gap-32 border-b justify-between bg-background mx-auto px-6 md:flex">
          ...
          <div
            className="shrink-0 text-6xl tracking-tight opacity-70"
          ...
          <nav className="flex items-center gap-1">
            {NAV_ITEMS.map((label) => (
              <div
                key={label}
                className="inline-flex items-center gap-1.5 rounded-md px-3 py-1.5 text-sm font-medium text-muted-foreground opacity-60"
              >
        ...
        <header className="flex flex-col bg-transparent md:hidden sticky top-0 z-50">
          <div className="flex h-14 mx-7 mt-6.5 items-center justify-between bg-transparent">
            <div className="flex items-center gap-2.5">
              <div
                className="text-5xl tracking-tight opacity-70"
                style={{ fontFamily: 'var(--font-geist-pixel-line)' }}
              >
                NumZero
              </div>
          ...
          <div className="bg-background">
            <div className="px-4 py-2.5">
              <div className="flex w-full items-center gap-3 px-4 py-3">
                <span
                  className="text-[14px] font-bold text-foreground opacity-60 tracking-tight uppercase"
            ...
            <div className="mx-auto max-w-7xl px-3 py-4 md:px-6 md:py-8">
              ...
              <section className="relative isolate overflow-hidden border border-border bg-card px-5 py-6 lg:hidden">
                ...
                <div className="relative z-10">
                  <h1 className="text-lg font-bold tracking-tight text-foreground opacity-70 md:text-2xl">
                    My Space
                  </h1>
                  <p className="mt-1.5 text-sm text-muted-foreground opacity-60">
              ...
              <section className="hidden lg:block mb-8">
                <div className="relative isolate overflow-hidden border border-border bg-card rounded-2xl px-8 py-8">
                  ...
                  <div className="pointer-events-none absolute inset-x-0 bottom-0 h-20 bg-gradient-to-t from-card to-transparent" />
                  <div className="relative z-10">
                    <h1 className="text-3xl font-bold tracking-tight text-foreground opacity-70">
                      My Space
                    </h1>
                    <p className="mt-2 text-muted-foreground opacity-60 max-w-xl">
                      Buy virtual numbers in seconds and verify your accounts with confidence.
                      Browse 700+ services across 145+ countries.
                    </p>
                  </div>
                </div>
              </section>
                ...
                <section>
                  ...
                  <div className="flex items-center gap-1.5 mt-3 overflow-x-auto scrollbar-hide pb-1">
                    ...
                    {CATEGORIES.slice(0, 6).map((cat) => (
                      <div
                        key={cat}
                        className="shrink-0 inline-flex items-center rounded-lg px-3 py-1.5 text-xs font-medium text-muted-foreground border border-transparent"
                      >
                        {cat}
                      </div>
                    ))}
                  ...
                  {/* Service count */}
                  <p className="mt-3 px-1 text-[12px] font-medium uppercase tracking-wider text-muted-foreground opacity-60">
                    -- / -- services
                  </p>
                  ...
                  <div className="mt-4 grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-4">
                    {Array.from({ length: 8 }).map((_, i) => (
                      <div
                        key={i}
                        className="flex flex-col items-center gap-3 rounded-2xl border border-border/50 bg-card p-5"
                      >
                ...
                <aside className="hidden lg:block space-y-5">
                  <div className="rounded-2xl border border-border/50 bg-card p-5">
                    <div className="flex items-center gap-2 mb-4">
                      ...
                      <h3 className="text-sm font-semibold text-foreground opacity-70">
                        Quick Actions
                      </h3>
                    </div>
                    <div className="space-y-1">
                      {['Recharge Credits', 'View Active Numbers', 'Account Settings'].map(
                        (item) => (
                          <div
                            key={item}
                            className="flex items-center justify-between rounded-xl px-3 py-2.5 text-sm font-medium text-muted-foreground opacity-60"
                          >
                            <span>{item}</span>
