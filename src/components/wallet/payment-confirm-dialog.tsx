    ...
    <div className='p-5 space-y-4'>
      <div className='flex items-start gap-3'>
        ...
        <div className='flex-1'>
          <h4 className='font-figtree text-[var(--sea-ink)] text-[18px] font-medium tracking-[-0.04em] leading-[1.25]'>Paiement non confirmé</h4>
      ...
      <div className='text-center py-2'>
        <p className='font-figtree text-[var(--sea-ink)] text-[18px] font-medium tracking-[-0.04em] leading-[1.25]'>Avez-vous effectué le paiement ?</p>
      </div>
